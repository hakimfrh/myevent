      ...
      Padding(
        ...
        child: Card(
          ...
          child: IntrinsicHeight(
            child: Container(
              width: double.infinity, // Pastikan lebar Card mengikuti container
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      trimString(order.booth!.deskripsiBooth),
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontWeight: FontWeight.normal,
                                        fontSize: 12,
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 5),
                                            Text(
                                              DateFormat('dd/MM/yyyy HH:mm').format(order.booth!.event!.pelaksanaanEvent),
                                              style: const TextStyle(
                                                fontSize: 10,
                                                fontWeight: FontWeight.bold,
                                                fontFamily: 'Rubik',
